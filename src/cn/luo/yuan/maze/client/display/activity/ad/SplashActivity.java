...
public class SplashActivity extends Activity implements SplashADListener {
  ...
  private static String APPID = "1104849170";
  private static String SplashPosID = "6040208900840052";
  ...
  public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
    ...
    if (requestCode == 1024 && hasAllPermissionsGranted(grantResults)) {
      ...
      Toast.makeText(this, "应用缺少必要的权限" + Arrays.toString(permissions) + "！请点击\"权限\"，打开所需要的权限。", Toast.LENGTH_LONG).show();
  ...
  public void onNoAD(int errorCode) {
    ...
    /** 如果加载广告失败，则直接跳转 */
    this.startActivity(new Intent(this, OnlineActivity.class));
    this.finish();
  }
