...
public class Monster extends HarmObject implements IDModel, SilentAbleObject, NameObject, SkillAbleObject,Cloneable, Serializable {
    ...
    private String type;
    private EncodeLong atk = new EncodeLong(0,StringUtils.NUMBER_STRING_FORMATTER);
    private EncodeLong hp= new EncodeLong(0,StringUtils.NUMBER_STRING_FORMATTER);
    private EncodeLong material= new EncodeLong(0,StringUtils.NUMBER_STRING_FORMATTER);
    private EncodeLong maxHP= new EncodeLong(0,StringUtils.NUMBER_STRING_FORMATTER);
    ...
    private int index;
    private EncodeLong def= new EncodeLong(0,StringUtils.NUMBER_STRING_FORMATTER);
