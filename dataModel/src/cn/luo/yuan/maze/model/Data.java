...
public class Data {
    ...
    public static final String BLUE_COLOR = "#0000FF";//蓝色（阶位）
    public static final String RED_COLOR = "#FF0000";//红色（阶位）
    public static final String  DEFAULT_QUALITY_COLOR = "#556B2F";//绿色（默认阶位）
    ...
    public static final String ORANGE_COLOR = "#FFA500";//橙色色（阶位）
    public static final String DARKGOLD_COLOR ="#B8860B";//暗金色（阶位）
