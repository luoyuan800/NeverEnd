 ...
 */
enum class WizardsrRealLevel(val point: Int, val level: Int, val display: String) {
    Bronze(5, 10, "炼气"), Silver(8, 10, "筑基"), Gold(15, 10, "金丹"), Platinum(20, 10, "元婴"), Diamond(30, 10, "化神"), Adamas(40, 10, "大乘"), Stars(40, 10, "飞升");
    ...
    companion object {
        ...
        private fun buildLevelString(level: WizardsrRealLevel, point: Long) = "${level.display} + ${point / level.point}"

        fun getCurrentLevel(p: Long): WizardsrRealLevel {
            var point = p
            if (point < Bronze.level * Bronze.point) {
                return Bronze
            }
